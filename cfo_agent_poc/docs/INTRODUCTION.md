...
![系统架构](assets/cfo-architecture.svg)
...
![消费数据处理流程](assets/cfo-data-flow.svg)
...
![数据模型](assets/cfo-data-model.svg)
...
![对话上下文注入](assets/cfo-chat-context.svg)
